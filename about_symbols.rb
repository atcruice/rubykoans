...
class AboutSymbols < Neo::Koan
  ...
  # if a Symbol was passed to include?() is would create the single
  # internal object when parsed and pollute the all_symbols list
  ...
  def test_symbols_can_be_dynamically_created
    # can't this be inferred from building symbols with interpolation
  ...
  # Symbols persist until program end (memory abuse issue)
end
