...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # a += b is syn-sugar for a = a + b (assignment, new object created)
  ...
  def test_strings_are_unique_objects
    ...
    # unlike Java where the compiler will notice if two strings have the
    # same value and assign them the same object
    assert_equal true, a           == b
