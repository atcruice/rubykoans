...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # never, even empty string returns empty string for a failed * match
  end
  ...
  #
  # Why?
  # they'll match as much as they can
  ...
  # THINK ABOUT IT:
  #
  # Explain the difference between a character class ([...]) and
  # alternation (|).
  # class match is a range of possible char values, alternation is
  # a range of possible patterns (really powerful!)
  ...
  def test_sub_is_like_find_and_replace
    # capture group 'two' is passed to block
    # value returned from block: 't' replaces match
